  ...
  const FreelancersTab = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-medium text-gray-900">Freelancer Directory</h3>
        <button
          onClick={() => window.open('/freelancers', '_blank')}
              ...
              <div className="px-4 py-4 flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="text-sm text-gray-500">
                      Rate: £{freelancer.hourlyRate || 0}/hr • £{freelancer.dailyRate || 0}/day
                    </div>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      onClick={() => window.open(`/freelancers?edit=${freelancer._id}`, '_blank')}
