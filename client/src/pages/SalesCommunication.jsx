        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#2EAB2C] text-white rounded-lg hover:bg-green-700"
            >
              Manage Templates
            </button>
          </div>
              ...
              <div key={template._id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-3 py-1 bg-[#2EAB2C] text-white rounded hover:bg-green-700 text-sm"
                  >
                    Use Template
                  </button>
                </div>
      ...
      {activeTab === 'automation' && (
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <button
              onClick={() => window.location.href = '#/email-automations'}
              className="px-4 py-2 bg-[#2EAB2C] text-white rounded-lg hover:bg-green-700"
            >
              Manage Automations
            </button>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="space-y-2 text-sm text-blue-800">
                <div className="flex items-center gap-2">
                  ...
                  <p><strong>Website Lead Captured</strong> → Contact form or subscription submitted</p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold">2</div>
                  <p><strong>Enters CRM</strong> → Contact created with lead source "website"</p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold">3</div>
                  <p><strong>Auto-Tagged</strong> → Tagged with interest areas (training, mentoring, etc.)</p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold">4</div>
                  <p><strong>Automated Email Sent</strong> → Follow-up email triggered based on tags</p>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold">5</div>
                  <p><strong>Admin Manages</strong> → View and manage all interactions in CRM</p>
                </div>
              </div>
            </div>

            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <h4 className="font-semibold text-yellow-900 mb-2">🎯 Quick Setup Guide</h4>
              <ol className="list-decimal list-inside space-y-1 text-sm text-yellow-800">
                <li>Create email templates for different interests (training, mentoring, etc.)</li>
                <li>Set up email automations with trigger: "contact_created"</li>
                <li>Add conditions to filter by tags (e.g., "training_interest")</li>
                <li>Configure recipients and delay settings</li>
                <li>Activate the automation</li>
              </ol>
            </div>

            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <h4 className="font-semibold text-green-900 mb-2">📊 API Endpoints for Website Integration</h4>
              <div className="space-y-2 text-sm text-green-800 font-mono">
                <div>
                  <strong>Contact Form:</strong> POST /api/leads/contact-form
                </div>
                <div>
                  <strong>Newsletter Subscribe:</strong> POST /api/leads/subscribe
                </div>
                <div>
                  <strong>Training Interest:</strong> POST /api/leads/training-interest
                </div>
                <div>
                  <strong>Mentoring Interest:</strong> POST /api/leads/mentoring-interest
                </div>
              </div>
            </div>
          </div>
